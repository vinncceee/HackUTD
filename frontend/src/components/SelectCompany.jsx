    ...
    <div>
      ...
      <div className="bg-primary-600 min-h-screen p-20">
        <div className="container mx-auto">
          <div className="mt-6">
            <label htmlFor="financial-company-select" className="block mb-2 text-sm font-medium text-gray-900">
            </label>
            <select
          ...
          <h2 className="text-black text-4xl font-rubik mt-12 mb-4">Feel free to tell us what you're interested in or curious about.</h2>
